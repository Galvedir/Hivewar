...
static func get_all() -> Array[Dictionary]:
	return [
		...
		{
			"id": "nyxa_cobweb", "name": "Nyxa Cobweb",
			"kingdoms": [Kingdoms.BLACK], "starting_health": 30,
			"text": "Leader of the Venom.",
			"hero_power_cost": 2,
			"hero_power_text": "Draw a card.",
			"hero_power_effects": [{"effect_id": "draw_card", "params": {"count": 1}}],
			"ultimate_cost": 5,
			"ultimate_text": "Summon three 1/1 Cicada Swarm tokens from the grave.",
			"ultimate_effects": [{"effect_id": "summon_token", "params": {"token_id": "cicada_swarm_token", "count": 3}}],
		},
		{
